  ...
  <header>
    ...
    <nav>
      ...
      <router-link to="about"
        ...
        <div v-else>About Me</div></router-link
      >
      <router-link to="project"
        ><div v-if="isOnMobile">
          <font-awesome-icon icon="fa-solid fa-briefcase" size="lg" />
        </div>
        <div v-else>Past Projects</div></router-link
      >
      <router-link to="blog"
        ><div v-if="isOnMobile">
          <font-awesome-icon icon="fa-solid fa-chart-column" size="lg" />
        </div>
